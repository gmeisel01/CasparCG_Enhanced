Audio-Video Sync & Multi-Channel Audio - REVISED
What This PR Does

Implements video-scheduled audio dispatch to address audio-video sync drift issues
Adds PortAudio consumer for professional multi-channel ASIO output
Enhances screen consumer with flexible output configuration for professional AV workflows
...
How It Works
cpp// Calculate precise target time based on video frame timing
...
cpp// Conservative adjustment only with consistent timing (stddev < 20ms)
...
xml<aspect-ratio>3840/1080</aspect-ratio>  <!-- Division format for ultra-wide -->
...
xml<brightness-boost>1.2</brightness-boost>  <!-- Output brightness adjustment -->
...
cppstd::priority_queue<audio_packet> audio_schedule_;
...
cppstatic const char* fragment_shader = R"shader(
    #version 450
